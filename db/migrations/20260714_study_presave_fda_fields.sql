...
CREATE INDEX IF NOT EXISTS idx_study_presave_fda_cross_reported_inds_parent
    ON study_presave_fda_cross_reported_inds(study_presave_id);

GRANT SELECT, INSERT, UPDATE, DELETE
    ON study_presave_fda_cross_reported_inds TO e2br3_app_role;
...
DROP POLICY IF EXISTS study_presave_fda_cross_reported_inds_via_parent ON study_presave_fda_cross_reported_inds;
...
DROP TRIGGER IF EXISTS audit_study_presave_fda_cross_reported_inds ON study_presave_fda_cross_reported_inds;
CREATE TRIGGER audit_study_presave_fda_cross_reported_inds
    AFTER INSERT OR UPDATE OR DELETE ON study_presave_fda_cross_reported_inds
    FOR EACH ROW EXECUTE FUNCTION audit_trigger_function();

DROP TRIGGER IF EXISTS update_study_presave_fda_cross_reported_inds_updated_at ON study_presave_fda_cross_reported_inds;
CREATE TRIGGER update_study_presave_fda_cross_reported_inds_updated_at
    BEFORE UPDATE ON study_presave_fda_cross_reported_inds
