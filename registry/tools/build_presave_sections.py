...
OFFICIAL = {
    ...
    "product": {
        ...
        ("ProductPresaveSubstance", "substance_name"): "G.k.2.3.r.1",
        ("ProductPresaveSubstance", "substance_termid_version"): "G.k.2.3.r.2a",
        ("ProductPresaveSubstance", "substance_termid"): "G.k.2.3.r.2b",
        ("ProductPresaveSubstance", "mfds_version"): "G.k.2.3.r.1.KR.1a",
        ("ProductPresaveSubstance", "mfds_id"): "G.k.2.3.r.1.KR.1b",
        ("ProductPresaveSubstance", "strength_value"): "G.k.2.3.r.3a",
        ("ProductPresaveSubstance", "strength_unit"): "G.k.2.3.r.3b",
    },
    "study": {
        ...
        ("StudyPresaveFdaCrossReportedInd", "ind_number"): "FDA.C.5.6.r",
    },
    "narrative": {
