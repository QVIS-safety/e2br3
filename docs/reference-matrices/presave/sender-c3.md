...
| `senderDepartment` | C.3.3.1 sender department | Canonical presave frontend surface; see current section implementation. | `sender_presaves.department`; `sender_presave_responsible_persons.department` | `safetyReportIdentification.senderDepartment` | `referenceImportedToCase` | import parent value or default responsible row |
...
| `senderPersonGivenName` | C.3.3.3 sender given name | Canonical presave frontend surface; see current section implementation. | `sender_presaves.person_given_name`; `sender_presave_responsible_persons.person_given_name` | `safetyReportIdentification.senderPersonGivenName` | `referenceImportedToCase` | import default responsible row when present |
