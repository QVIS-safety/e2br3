...
<MCCI_IN200100UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	...
	let _ = parse_f_test_results(xml).expect("parse");
}

#[test]
fn import_f_test_allows_missing_test_name_for_validation_phase() {
	let xml = br#"<?xml version="1.0" encoding="utf-8"?>
<MCCI_IN200100UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<PORR_IN049016UV>
		<controlActProcess>
	...
	let tests = parse_f_test_results(xml).expect("parse should succeed");
