...
pub(crate) async fn fetch_patient_information(
	ctx: &Ctx,
	mm: &ModelManager,
...
pub(crate) async fn fetch_patient_identifiers(
	ctx: &Ctx,
	mm: &ModelManager,
...
pub(crate) async fn fetch_parent_information(
	ctx: &Ctx,
	mm: &ModelManager,
	patient_id: sqlx::types::Uuid,
...
pub(crate) async fn fetch_case_summaries(
	ctx: &Ctx,
	mm: &ModelManager,
...
pub(crate) async fn fetch_sender_diagnoses(
	ctx: &Ctx,
	mm: &ModelManager,
	narrative_id: sqlx::types::Uuid,
...
pub(crate) async fn fetch_past_drug_history(
	ctx: &Ctx,
	mm: &ModelManager,
	patient_id: sqlx::types::Uuid,
...
pub(crate) fn ensure_patient_observation(
	xpath: &mut Context,
	doc: &mut Document,
	parser: &Parser,
	code: &str,
...
pub(crate) fn ensure_patient_history_organizer(
	xpath: &mut Context,
	doc: &mut Document,
	parser: &Parser,
) -> Result<()> {
...
pub(crate) fn ensure_patient_history_text(
	xpath: &mut Context,
	doc: &mut Document,
	parser: &Parser,
) -> Result<()> {
...
pub(crate) fn ensure_patient_identifier(
	xpath: &mut Context,
	doc: &mut Document,
	parser: &Parser,
	id_type_code: &str,
...
pub(crate) fn ensure_parent_role(
	xpath: &mut Context,
	doc: &mut Document,
	parser: &Parser,
) -> Result<()> {
